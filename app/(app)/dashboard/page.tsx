    ...
    <>
      <style>{`
        ...
        @media (max-width: 1023px) {
          .dash-wrapper { padding: 72px 16px 24px; }
      ...
      <div className="dash-wrapper">
        ...
        <div className="dash-header">
          <div>
            <h1 className="font-black text-white">Good morning, Amanpreet 👋</h1>
        ...
        <div className="dash-bottom">
          <div className="dash-recent rounded-2xl p-6" style={{ backgroundColor: '#1E1E1E', border: '1px solid #2A2A2A' }}>
